...
-- Start by retrieving the corresponding crime scene report from the police department’s database. Figure out who committed the crime with
-- the details you remembered above."
